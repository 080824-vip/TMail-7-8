...
sudo apt install -y php8.1 php8.1-mysql php8.1-openssl php8.1-pdo php8.1-mbstring php8.1-tokenizer php8.1-xml php8.1-ctype php8.1-json php8.1-bcmath php8.1-imap php8.1-iconv php8.1-zip php8.1-fileinfo composer unzip wget
